...
from environments.smolagents_integration.gaia_benchmark_env import GAIABenchmarkConfig, GAIABenchmarkEnv
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Run GAIA benchmark with Atropos-SmolaGents integration")
    ...
    parser.add_argument("--wandb-name", type=str, default="gaia-benchmark",
